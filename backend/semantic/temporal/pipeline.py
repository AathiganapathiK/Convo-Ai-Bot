...
from .models import TimeSettings, TimeResolutionResult, BaseTimeIntent, TimeContext
...
class TemporalPipeline:
    ...
    @classmethod
    def get_last_time_context(cls) -> Optional[TimeContext]:
        return getattr(cls._thread_local, "last_time_context", None)

    @classmethod
    def clear_last_result(cls):
        cls._thread_local.last_resolution = None
        cls._thread_local.last_intent = None
        cls._thread_local.last_time_context = None
    ...
    def build(
        ...
        try:
            ...
            self._thread_local.last_time_context = time_context
